...
declare module WL.AuthorizationManager {
		...
		/**
		 * @deprecated Use WLAuthorizationManager.obtainAccessToken() instead.
	     ...
	     * @example    
		 * WL.AuthorizationManager.obtainAccessToken(scope)
		 * .then (
    ...
    function obtainAccessToken(scope?: string): WLPromise;
		...
		/**
		 * @deprecated Use WLAuthorizationManager.login() instead.
	...
	function login(securityCheck: string, credentials: Object): WLPromise;
	    ...
	    /**
		 * @deprecated Use WLAuthorizationManager.logout() instead.
	...
	function logout(securityCheck: string): WLPromise;
		...
		/**
		 * @deprecated Use WLAuthorizationManager.isAuthorizationRequired() instead.
    ...
    function isAuthorizationRequired(responseStatus: number, responseHeaders: Object): boolean;
		...
		/**
		 * @deprecated Use WLAuthorizationManager.clearAccessToken() instead.
		 * @description Checks whether the provided response status and headers represent a protected resource that requires authorization.
		 * @param {Integer} responseStatus Mandatory. Specifies the response status code.
		 * @param {String} responseHeaders Mandatory. A String representation of the response headers separated by CRLF, as returned from XMLHttpRequest.getAllResponseHeaders().
		 * @returns A boolean value, indicating whether authorization is required (<code>true</code>), or not (<code>false</code>).
	...
	function clearAccessToken(accessToken: Object): WLPromise;
		...
		/**
		 * @deprecated Use WLAuthorizationManager.getResourceScope() instead.
    ...
    function getResourceScope(responseHeaders: string): string;
		 ...
		 /**
		 * @deprecated Use WLAuthorizationManager.setAuthorizationServerUrl() instead.
    ...
    function setAuthorizationServerUrl(url: string): WLPromise;
	    ...
	    /**
		 * @deprecated Use WLAuthorizationManager.getAuthorizationServerUrl() instead.
...
declare module WL{
	class ResourceRequest {
		...
		* The WL.AuthorizationManager and WL.ResourceRequest classes are supported for the following hybrid environments only:
		...
		*/
			...
			/**
			 * @deprecated Use WLResourceRequest.getUrl() instead.
			 * @description Returns request URL. The URL must have been passed to the constructor.
			 * @methodOf WL.ResourceRequest#
			 */
			getUrl(): string;

			/**
			 * @deprecated Use WLResourceRequest.getMethod() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.getQueryParameters() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.setQueryParameters() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.setQueryParameter() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.getHeaders() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.getHeaderNames() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.getHeader() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.setHeaders() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.setHeader() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.addHeader() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.getTimeout() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.setTimeout() instead.
			...
			/**
			 * @deprecated Use WLResourceRequest.send() instead.
			 ...
			 * @returns Promise
			 * @example
			 * var request = WL.ResourceRequest(url, method, options);
			...
			/**
			 * @deprecated Use WLResourceRequest.sendFormParameters() instead.
