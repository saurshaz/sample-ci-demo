...
class OtherBankConfirmTrans extends React.Component {
    constructor(props) {
        super(props);
        ...
        axios.post('/fundTransfer', fundTransParams).then(response => {
            ...
            axios.post('/getAllAccountsOfUser', params).then(accounts => {
                ...
                if (accounts || accounts.data || accounts.data.array) {
                    ...
                    this.props.history.push("/fundTransfer/otherBank/successTrans");
                }
            }).catch(error => {
...
export default withRouter(OtherBankConfirmTrans)